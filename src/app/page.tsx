...
function Navigation({ scrolled, isMenuOpen, setIsMenuOpen, closeMenu }: { 
  scrolled: boolean; 
  isMenuOpen: boolean; 
...
function MobileMenuButton({ scrolled, isMenuOpen, setIsMenuOpen }: { 
  scrolled: boolean; 
  isMenuOpen: boolean; 
  setIsMenuOpen: (value: boolean) => void;
}) {
  ...
  return (
    <section id="features" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <SectionHeader
          title="Why Schools Choose Our Platform"
          subtitle="Integrating Logic Programming with STEM Education"
          category="Features"
        />
...
function SectionHeader({ title, subtitle, category }: { 
  title: string; 
  subtitle: string; 
  category: string;
}) {
  return (
    <div className="text-center mb-16">
      <span className="text-blue-600 font-semibold uppercase tracking-wider">{category}</span>
...
function FeatureCard({ feature }: { feature: Feature }) {
  return (
    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100 hover:border-blue-100">
...
function ProjectsSection({ projects, currentSlide, setCurrentSlide }: { 
  projects: Project[]; 
  currentSlide: number; 
  ...
  return (
    <section id="projects" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <SectionHeader
          title="Featured STEM Projects"
          subtitle="See how schools are using Prolog for AI and problem-solving across disciplines."
          category="Showcase"
        />
...
function Carousel({ projects, currentSlide, setCurrentSlide }: { 
  projects: Project[]; 
  currentSlide: number; 
  setCurrentSlide: (value: number) => void;
}) {
          ...
          <div key={index} className="w-full flex-shrink-0 relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end p-8">
              <div>
                ...
                <Link href="#" className="inline-block mt-4 px-6 py-2 bg-blue-600 text-white rounded-full font-medium hover:bg-blue-700 transition-colors">
                  View Case Study
                </Link>
              </div>
            </div>
...
function CarouselControls({ currentSlide, setCurrentSlide, count }: { 
  currentSlide: number; 
  setCurrentSlide: (value: number) => void;
  count: number;
}) {
...
function CarouselDots({ count, currentSlide, setCurrentSlide }: { 
  count: number; 
  currentSlide: number; 
  setCurrentSlide: (value: number) => void;
}) {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <SectionHeader
          title="How It Works"
          subtitle="Simple steps to integrate logical programming into your STEM curriculum."
          category="Process"
        />
  ...
  return (
    <div>
      ...
      <ul className="space-y-2">
        ...
        <li><Link href="#" className="hover:text-white transition-colors">Lesson Plans</Link></li>
